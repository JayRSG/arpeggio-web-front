...
import apiClient, {
  socialVideoAvailableEndPoint,
  socialVideoLinkEndPoint,
  spaAuth,
} from "../../../util/api";
...
const AddVideo = (props) => {
  ...
  const checkAvailability = () => {
    ...
    if (formData.link != "") {
      ...
      apiClient
        .get(socialVideoAvailableEndPoint + video_id)
        .then((response) => {
    ...
    await apiClient
      ...
      .then(async () => {
        return await apiClient
          .post(socialVideoLinkEndPoint, formData)
          .then((response) => {
            if (response) {
              ...
              <div className="flex flex-col justify-center bg-main-color">
                ...
                <div ref={videoContentRef}>
                  ...
                  <div className="">
                    <select
                      ...
                      onChange={(e) => {
                        setTypeHook(e.currentTarget.selected);
                        setFormData({
                          ...formData,
                          link_type: e.currentTarget.value,
                        });
                    ...
                    >
                      ...
                      <option value="2" key="BackingTrack">
                        Backing Track
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="bg-green-400">
                    {youtubeDataAvailable
                      ? "Video Avaiable in - " +
                        (youtubeDataAvailable.link_type == 1
                          ? "Free Class"
                          : "Backing Track")
                      : ""}
                  </div>
                ...
                <div className="flex justify-between">
                  <input
                    ...
                    name="link"
                    onClick={() => {
                      setNewLinkCount((newLinkCount) => newLinkCount.push(1));
                    }}
                  />
