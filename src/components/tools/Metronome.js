...
const Metronome = props => {
    ...
    return (
        <div className="text-gray-500 pl-8 lg:pl-4 min-h-screen w-full font-body">
            <div className="flex flex-col ">
                ...
                <main className="mt-8 flex min-w-full flex-wrap">
                    ...
                    <div className="pl-16 lg:pl-4 lg:mt-8 md:pl-16 md:mt-0 sm:mt-8 sm:pl-4">
