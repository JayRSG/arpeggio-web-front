					...
					<Menu as='div' className='relative inline-block text-left'>
						<div>
							<Menu.Button className='inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-btn-color transition-colors duration-500 rounded-md hover:bg-opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'>
								<FontAwesomeIcon icon={faUserAlt} size='1x' className='mr-3 self-center' />
								<span className={`${props.className1}`}>{props.user_name}</span>
								<FontAwesomeIcon icon={faChevronDown} className='w-5 h-5 ml-2 -mr-1 mt-1' size='1x' aria-hidden='true' />
							</Menu.Button>
						</div>
						<Transition
							as={Fragment}
							...
							<Menu.Items className='absolute right-0 w-40 mt-2 origin-top-right bg-btn-color divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
