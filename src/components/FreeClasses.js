            ...
            <div className="px-52 md:px-0 sm:px-0 2xl:px-28 xl:px-28 lg:px-28">
                <div className="flex flex-col font-body min-h-screen">
                    <div className="w-full flex justify-between mb-8 lg:flex-col lg:justify-center md:flex-col md:justify-center sm:flex-col sm:justify-center items-center mt-8 flex-wrap">
                        <h1 className="text-5xl font-title py-7 font-bold lg:text-center md:text-center sm:text-center md:mb-8 sm:mb-8">
                            Free Classes
                        </h1>
                        ...
                        <div className="flex border-2 h-12 border-black md:mx-4 sm:mx-4 lg:mr-0 lg:mb-16 md:mb-16 sm:mb-16 shadow-md">
                            <input
                                type="text"
                                className="w-121 xl:w-96 lg:w-119 md:w-118 sm:w-56 px-4 opacity-50 outline-none"
                                ...
                                <div key={ind} className="h-full">
                                    <div
                                        ...
                                        <Image
                                            ...
                                            priority={false}
                                        />
                                        <p className="text-base lg:text-sm text-center font-bold p-4">
                                            {elems.title}
                                        </p>
                                    </div>
                                </div>
