...
const Navbar = () => {
    ...
    const SideBar = () => {
        return (
            <div ref={sideBarRef}>
                <ul className="absolute transition-all duration-500 flex flex-col top-16 w-3/5 md:w-1/2 h-screen bg-btn-color font-body font-bold z-50 left-0 pl-4">
    ...
    return (
        <>
            <div>
                <nav className="flex justify-between min-w-full h-40 md:h-24 sm:h-28 flex-col bg-main-color text-body shadow-md px-52 2xl:px-28 xl:px-28 lg:px-28 md:px-0 sm:px-0">
                    <div className="flex justify-between sm:justify-center large:justify-center">
                        {/* Logo */}
                        <Link href="/">
                            <a>
                                <Logo className="relative top-4 large:-top-4 md:left-2/4 sm:-top-4 sm:left-2/4 transform -translate-x-2/4 p-4 sm:p-7 sm:mb-4 sm:ml-4 sm:mt-4 left-32 sm:z-40" />
                            </a>
                        </Link>
                    ...
                    <ul className="md:hidden font-body font-bold sm:hidden list-none flex justify-between items-center w-1/2 2xl:w-133 lg:w-146 self-end pb-2">
