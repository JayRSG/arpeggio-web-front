...
import { faUser, faClock, faPlayCircle } from "@fortawesome/free-regular-svg-icons";
								...
								<div className='flex flex-col bg-main-color px-6 w-full shadow-md rounded'>
									...
									<div className='flex justify-around mt-8 items-center'>
										<div className='flex items-center'>
											<FontAwesomeIcon icon={faUser} size='2x' className='text-btn-color mr-2' />
											<p className='laptop:text-sm tablet:text-sm mobile:text-sm'>50 students</p>
										</div>

										<div className='flex items-center'>
											<FontAwesomeIcon icon={faPlayCircle} size='2x' className='text-btn-color mr-2' />
											<p className='laptop:text-sm tablet:text-sm mobile:text-sm'>8 videos</p>
										</div>
									</div>

									<div className='flex flex-wrap justify-around mt-8 items-center'>
										<div className='flex items-center'>
											<FontAwesomeIcon icon={faClock} size='2x' className='text-btn-color mr-2' />
											<p className='laptop:text-sm tablet:text-sm mobile:text-sm'>2 months</p>
										</div>
										...
										<div className='flex items-center'>
											...
											<p className='ml-2 laptop:text-sm tablet:text-sm mobile:text-sm'>Beginner</p>
										</div>
									</div>
