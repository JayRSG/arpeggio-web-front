    ...
    return (
        <>
            <AppLayout type="Determine">
                ...
                <h1 className="text-5xl font-title p-7 pl-20 font-bold md:text-center sm:text-center md:pl-0 md:p-0 sm:p-0 md:py-7 sm:py-7 sm:pl-0 pt-6">
                    Profile
                </h1>
              ...
              */}
                    ...
                    <div className="w-full flex flex-col justify-center px-16 lg:pr-8 xl:pr-4 sm:px-4">
                        {/* first name */}
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                id="institution"
                                name="institution"
                                defaultValue={user?.data?.institute}
                                placeholder=""
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                id="occupation"
                                name="occupation"
                                defaultValue={user?.data?.occupation}
                                placeholder=""
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                id="contact"
                                name="contact"
                                defaultValue={user?.data?.contact_number}
                                placeholder=""
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                name="division"
                                placeholder=""
                                defaultValue={user?.data?.division}
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                id="street"
                                name="street"
                                defaultValue={user?.data?.street_address}
                                placeholder=""
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                id="social-account"
                                name="social-account"
                                defaultValue={user?.data?.social_provider}
                                placeholder=""
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                id="acoount-name"
                                name="acoount-name"
                                defaultValue={user?.data?.social_name}
                                placeholder=""
                                disabled={disabled}
                            />
                        </div>
                        ...
                        <div className="flex justify-between my-8">
                            <a className="text-blue-500 text-lg font-bold">
                                Change Password
                            </a>
                            <a
                                className="btn rounded-lg bg-blue-500 text-xl px-10"
                                onClick={disabledHandler}>
                                Edit
                            </a>
                        </div>
